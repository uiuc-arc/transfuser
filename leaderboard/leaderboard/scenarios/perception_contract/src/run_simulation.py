...
def sample_config_from_space(fixed_config=None):
    """
    ...
    if fixed_config is not None and "npc_speed" in fixed_config:
        ...
        npc_speed = round(np.random.uniform(0.5, 15.0), 6)
...
if __name__ == "__main__":
    ...
    config = sample_config_from_space({"npc_min_starting_distance": 19, "npc_speed": 0.45})
