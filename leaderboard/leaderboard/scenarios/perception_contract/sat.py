...
def check_collision(vertices_a, vertices_b):
    """
    Check if two convex polygons defined by their vertices collide using the Separating Axis Theorem.
    
    :param vertices_a: List of tuples representing the vertices of polygon A.
    :param vertices_b: List of tuples representing the vertices of polygon B.
